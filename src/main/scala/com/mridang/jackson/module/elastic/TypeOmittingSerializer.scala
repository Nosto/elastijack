 ...
 * [[com.fasterxml.jackson.databind.annotation.JsonTypeIdResolver]] or
 * [[com.fasterxml.jackson.module.jsonSchema.JsonSchemaIdResolver]]
 * hack to overwrite the type property. Instead, omit type info completely by wiring
 * serializeWithType to non-typed implementation and simply add type as a regular property.
 */
